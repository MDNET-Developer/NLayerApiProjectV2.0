...
{
    //Accepted generic style T data
    public class CustomResponseDto<T>
    {
        //Introduce T data there
        public T Data { get; set; }

        //We have many erros, so we introduce List<String> type Erros
        public List<String> Errors { get; set; }

        [JsonIgnore] //Biz status kodu tutmaq isteyirik. Amma bu status kodu clientlere vermek istemirik. Onsuzda onlar PostMan ile yoxlama eden zaman status kodu gorecekler. Bu bizim proqram daxili status kodu tutmaq ucun lazimdir. Ona gorede JsonIgnore yazdiq ki, clientlere getmesin
